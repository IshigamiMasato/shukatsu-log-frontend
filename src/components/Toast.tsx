...
const Toast = () => {
    ...
    return (
        <>
            { isDisp && (
                <div className={ `toast-wrapper fixed flex items-center divide-x rtl:divide-x-reverse bottom-5 right-1 mx-auto p-2 rounded-lg shadow-md mb-3 z-50 ${ status === "success" ? "bg-green-600 text-white" : "bg-red-600 text-white" }` }>
                    { status === "success"
